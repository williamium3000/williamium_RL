...
class MCTS(object):
    ...
    def _playout(self, state):
        ...
        while(1):
            ...
            state.step(state.move2coor(action))
    ...
    def _evaluate_rollout(self, state, limit=1000):
        ...
        for i in range(limit):
            ...
            state.step(state.move2coor(max_action))
        else:
...
class MCTSPlayer(Player.player):
    ...
    def play_action(self, board):
        ...
        if len(sensible_moves) > 0:
            ...
            self.mcts.update_with_move(-1)
            return board.move2coor(move)
        else:
            print("WARNING: the board is full")

    def __str__(self):
        return "MCTS player(id:{})".format(self.id)
